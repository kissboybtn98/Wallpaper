...
public class AdapterPosst extends RecyclerView.Adapter<AdapterPosst.ViewHolder> {
    ...
    public AdapterPosst(List<String> arrPosst, Context context) {
        this.arrPosst2 = arrPosst;
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterPosst.ViewHolder holder, int position) {
